    ...
    <div class="content-body"><!-- Zero configuration table -->
        <section id="configuration">
            ...
            <div class="card-header">
                ...
                <strong>DEVICE REGISTRATION FORM</strong>
                </span> <br>
                <span>
                            ...
                            <div class="col-md-12">
                                <div class="form-body">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="deviceName" class="form-control round" placeholder="Device Name" name="deviceName">
                                    </div>

                                    <div class="form-group">
                                        <label for="deviceLocation"><strong>Device Location</strong></label>
                                        <input type="text" id="deviceLocation" class="form-control round" placeholder="Device Location" name="deviceLocation">
                                    </div>

                                    <div class="form-group">
                                        <label for="deviceLongitude"><strong>Device Longitude</strong></label>
                                        <input type="text" id="deviceLongitude" class="form-control round" placeholder="Device Longitude" name="deviceLongitude">
                                    </div>

                                    <div class="form-group">
                                        <label for="deviceLatitude"><strong>Device Latitude</strong></label>
                                        <input type="text" id="deviceLatitude" class="form-control round" placeholder="Device Latitude" name="deviceLatitude">
                                    </div>
                                </div>
                            </div>
                        </div>
